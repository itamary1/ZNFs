...
if __name__ == "__main__":
    sites = pandas.read_csv(
        "/private8/Projects/itamar/ZNF/orshai_editing_sites/above_10_sites.csv"
    )
    genes_binding = pandas.read_csv(
        "/private8/Projects/itamar/ZNF/orshai_editing_sites/above_10_genes_result.csv"
    )
    ...
    fingerprint_sites = fingerprint_sites[
        fingerprint_sites["amino_change"].isin(change_list)
    ]
    old_prot_seq = []
    new_prot_seq = []
