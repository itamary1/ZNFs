...
if __name__ == "__main__":
    ...
    genes = pd.read_csv(
        "/private8/Projects/itamar/ZNF/Sra_GSE73211_35_samples/REDI/curated/domain_editing/above_40_geneID.csv"
    )
    # all editing sites
    sites = pd.read_csv(
        "/private8/Projects/itamar/ZNF/Sra_GSE73211_35_samples/REDI/curated/domain_editing/above_40_sites.csv"
    )
    ...
    for index, gene in genes.iterrows():
        ...
        for index, site in g_sites.iterrows():
            ...
            assert orig_amino == prot_seq[amino_place], (
                orig_amino + prot_seq[amino_place]
            )
    ...
    sites_in_fingerprints.to_csv(
        (dir + "above_40_sites_in_fingerprints_result.csv"), index=False
    )
