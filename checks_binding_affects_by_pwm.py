...
if __name__ == "__main__":
    genes_result = pd.read_csv(
        "/private8/Projects/itamar/ZNF/Sra_GSE73211_35_samples/REDI/curated/domain_editing/above_40_genes_result.csv"
    )
    genes_all_changes = pd.read_csv(
        "/private8/Projects/itamar/ZNF/Sra_GSE73211_35_samples/REDI/curated/domain_editing/above_40_geneID_with_changes.csv"
    )
